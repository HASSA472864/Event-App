  ...
  return (
    <Card className="bg-slate-900/50 backdrop-blur-xl border-slate-800/50 shadow-2xl">
      <CardHeader className="text-center">
        ...
        <CardDescription className="text-slate-400">Sign in to your EventFlow account</CardDescription>
      </CardHeader>
      ...
      <CardFooter className="justify-center">
        <p className="text-sm text-slate-400">
          ...
          <Link href="/auth/register" className="text-violet-400 hover:text-violet-300 font-medium">Sign up</Link>
        </p>
      </CardFooter>
    </Card>
  )
